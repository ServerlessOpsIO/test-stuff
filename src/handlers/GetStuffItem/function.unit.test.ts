...
import { StuffItemKeys, StuffItemData } from '../../lib/StuffItem.js'
...
describe('GetStuffItem', () => {
    ...
    describe('getItem()', () => {
        let itemKeys: StuffItemKeys
        let itemData: StuffItemData
        ...
        describe('should fail when', () => {
            test('getting non-existent', async () => {
                ...
                ).rejects.toThrow(new Error('StuffItem not found'))
